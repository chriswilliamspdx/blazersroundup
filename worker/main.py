...
def build_summary_fact_check_prompt(exclude_note: str, summary_limit: int = 250, facts: list[str] | None = None) -> str:
    ...
    return (
        ...
        "Every person named in the final text must use a supplied canonical name. "
        "Declare that person's supplied ID only in entity_ids metadata, never in the public summary text. "
